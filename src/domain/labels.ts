...
export const AUDIT_LABEL: Record<AuditType, string> = {
  ...
  'group.member': '群成员',
  'group.admin': '群管理员',
  'group.restrict': '禁言与移出并禁止再进',
  'group.invite_link': '群邀请链接',
  'group.create': '建群',
  'message.edit': '编辑消息',
  'message.recall': '为所有人删除消息',
  'customer.ban': '封禁客户',
  'customer.mute': '全部禁言客户',
  'customer.unmute': '解除客户全部禁言',
  'customer.group_mute': '群聊禁言客户',
  'customer.group_unmute': '解除客户群聊禁言',
