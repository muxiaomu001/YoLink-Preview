  ...
  return (
    <div className={compact ? 'border-b border-zinc-100 px-4 py-4' : 'rounded-lg border border-zinc-200 bg-white p-4'}>
      ...
      <div className="mt-3">
        <KV
          items={[
            { k: '成员', v: <button type="button" className="text-brand-700 hover:underline" onClick={jumpMembers}>{memberTotal(g)} 人（{g.memberCustomerIds.length} 客户 · {g.memberSeatIds.length} 坐席）</button> },
