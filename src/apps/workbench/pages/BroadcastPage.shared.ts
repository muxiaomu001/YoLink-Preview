...
export const TARGET_LABEL: Record<BroadcastTargetKind, string> = { friends: '全部好友', mine: '主归属客户', tag: '按内部标签', title: '按头衔', purchase: '按业务记录', role: '按业务系统角色', group: '指定群', coverage: '多坐席覆盖' }
